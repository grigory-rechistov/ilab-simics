...
def test_muli_availability(cpu):
        ...
        # MULI
        chip16_write_phys_memory_BE(cpu, paddr, 0x90070c00, 4)
        SIM_continue(1)
        ...
        print "MULI_test-1: regs OK."

        # check flags
        print "MULI_test-1: checking flags..."
        stest.expect_equal(cpu.flags, 0)
        print "MULI_test-1: flags OK."

        print "MULI_test-1: All is OK!"
